                            ...
                            {filteredData.length > 0 ? (
                                filteredData.map((record) => (
                                    <tr key={record.id} className="hover:bg-slate-700/30 transition-colors group">
                                        <td className="p-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-slate-500 text-xs">ID: #{1000 + record.id}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="p-4 text-slate-300 text-sm">{record.department}</td>
                                        <td className="p-4">
                                        ...
                                        <td className="p-4 text-slate-300 font-mono text-sm">{record.totalHours}</td>
