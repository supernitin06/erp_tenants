        ...
        <div className="flex gap-2 items-center">
          ...
          {filterOptions.map((option) => (
            <select
              ...
              className="px-4 py-2.5 bg-white dark:text-white dark:bg-slate-900 border dark:text-white border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 outline-none transition-all min-w-[150px]"
              disabled={loading}
            >
          ...
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 0v2.586a1 1 0 011-.293.707L12.586 7.414a1 1 0 011-.293-.707L3 4a1 1 0 011 0z" />
            </svg>
