...
const Navbar = ({ onMenuClick }) => { // onMenuClick prop Layout se aa raha hai
    const { user, logout } = useAuth();
    ...
    return (
        <nav className="h-16 bg-slate-900/50 backdrop-blur-md border-b border-slate-800 flex items-center justify-between px-4 md:px-8 sticky top-0 z-10">
            ...
            <div className="flex items-center gap-4">
                {/* Hamburger Menu: Sirf mobile (md:hidden) par dikhega */}
                <button
                    onClick={onMenuClick}
            ...
            <div className="flex items-center gap-3 md:gap-6">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                    {/* User Info: Mobile par hide kar diya hai space bachane ke liye */}
